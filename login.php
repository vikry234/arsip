...
if (isset($_SESSION['status'])) {
    if ($_SESSION['status'] == "admin_login") {
        ...
        exit;
    } elseif ($_SESSION['status'] == "petugas_login") {
        header("location:petugas/");
        exit;
    } elseif ($_SESSION['status'] == "user_login") {
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <img src="assets/img/logo/logosindur.png" alt="">
                <h3>ARSIP DIGITAL</h3>
                <h3>KECAMATAN GUNUNGSINDUR </h3>
            </div>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Malas Ngoding</p>
            </div>
        </div>
    </div>
