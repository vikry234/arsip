...
<div class="container-fluid">
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            // Set default value untuk bulan dan kategori
            ...
            // Membuat kondisi untuk filter berdasarkan bulan dan kategori
            $bulan_condition = '';
            $kategori_condition = '';

            if (!empty($bulan)) {
                $bulan_condition = "AND MONTH(arsip_waktu_upload) = '$bulan'";
            }
      ...
      WHERE 1=1 $bulan_condition $kategori_condition
      ORDER BY arsip_id DESC";
            $result = mysqli_query($koneksi, $query);

            echo "<h2 class='text-center'>Laporan Dokumen Arsip Bulanan</h2>";
