            ...
            <div class="panel panel">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="arsip_aksi.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>File</label>
                            <input type="file" name="file" required="required" accept=".pdf, .docx, .jpg, .jpeg, .png">
                            <!-- Tambahkan pesan kesalahan jika file tidak diisi -->
                            <?php if (isset($_GET['error']) && $_GET['error'] == 'filekosong') { ?>
                                <div class="alert alert-danger" role="alert">File tidak boleh kosong!</div>
                            <?php } ?>
                        </div>
